function [f,k,state] = element_routine(x, y, u, du, params, state_old,...
                                       t, log_strain)
...
[f,state] = get_intern_eq_forces(xy0, xy, params, state_old, t, log_strain);

[~,~,k] = get_tangent_matrices(xy0, xy, params, state_old, t, log_strain);
end